...
public class TestLauncher {
	...
	public void execute(Session session) {
        ...
        scriptRunner = new RhinoScriptRunner(new FileScript(scriptName), session.getSuite(), this);
		...
		browserLauncher = new BrowserLauncher(browser, browserProcessName, browserOption);
