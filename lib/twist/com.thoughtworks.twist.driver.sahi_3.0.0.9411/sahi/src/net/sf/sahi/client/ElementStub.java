...
public class ElementStub {
	...
	public String toString(){
		...
		for (Object o: identifiers){
			...
			start = false;
			sb.append(getArgument(o));
		}
		return "_sahi._" + elementType + "(" + sb.toString() + ")"; 
	}

	private String getArgument(Object o) {
		String s = o.toString();
	 ...
	 * Eg. browser.link("delete").in(browser.cell("user1").parentNode()).click();<br/>
	 ...
	 * Eg. browser.link("delete").near(browser.cell("user1")).click();<br/>
