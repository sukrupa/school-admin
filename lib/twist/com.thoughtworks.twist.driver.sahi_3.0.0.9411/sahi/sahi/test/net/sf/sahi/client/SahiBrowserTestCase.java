...
//	public ElementStub _getCellText(Object... args) {return new ElementStub("getCellText", args);}
	...
	public void initBrowser(String browserPath, String browserProcessName, String browserOption){
		this.browser = new Browser(browserPath, browserProcessName, browserOption);
	}
}