...
public class ReferenceDataRepository {
    ...
    private final List<String> STUDENT_CLASSES = asList("Preschool", "LKG", "UKG", "1 Std", "2 Std", "3 Std", "4 Std", "5 Std", "6 Std", "7 Std", "8 Std", "9 Std", "10 Std");
    private final List<String> GENDERS = asList("", "Male", "Female");
    private final List<String> CASTES = asList("", "Achari", "Agnikula", "Arya Vashya", "Baljigru", "Bhramin", "Bohvi", "Chettyar",
    ...
    private final List<String> SUBCASTES = asList("", "Adi Drawida", "Adi Janaga", "Adi Karnataka", "Bale -Balijigru", "Bale Banjaguru", "BC",
    ...
    private final List<String> COMMUNITY_LOCATIONS = asList("", "Bhuvaneshwari Slum", "Chamundi Nagar",
    ...
    private final List<String> FAMILY_STATUSES = asList("", "General", "Single", "Destitute", "Orphan");

    private final List<String> OCCUPATIONS = asList(" ", "Assitant Captain", "Auto Driver", "Baker", "Bar Bender", "Barman",
    ...
    private final List<String> RELIGIONS = asList("", "Christian", "Hindu", "Muslim", "Sikh");

    private final List<String> TALENTS = asList("Acting", "Arts & Crafts", "Creative Writing", "Dancing", "Mimicry",
    ...
    private final List<String> STATUSES = asList("Existing Student", "Dropout", "Alumni");

    private final boolean SPONSORED = false;
    private final List<String> MARITAL_STATUSES = asList(" ", "Married", "Single", "Divorced", "Widowed", "Deceased");
