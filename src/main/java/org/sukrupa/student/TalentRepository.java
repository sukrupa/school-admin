...
public class TalentRepository {
	...
	public Set<Talent> findTalents(Set<String> talentsDecriptions) {
		...
		Criteria criteria = sessionFactory.getCurrentSession().createCriteria(org.sukrupa.student.Talent.class).add(disjunction);
		return new HashSet<org.sukrupa.student.Talent>(criteria.list());
	}
}
