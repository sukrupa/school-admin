...
class SQLGeneratorTest < Test::Unit::TestCase
  ...
  def test_should_generate_insert_statement
    ...
    assert_equal("INSERT INTO student (name,gender,date_of_birth) VALUES ('minno','female','2004-10-15');", @generator.generate_sql(student))
  end
  
  def test_should_be_able_to_cope_with_missing_values
    student = Student.new :name => 'minno'
    assert_equal("INSERT INTO student (name) VALUES ('minno');", @generator.generate_sql(student))
  end
  ...
  # 
  #   assert_equal(sql_statements[0], "INSERT INTO student (name) VALUES ('minno');")
  #   assert_equal(sql_statements[1], "INSERT INTO student (name) VALUES ('pat');")    
  # end
