...
Feature: Add, Edit and Delete Small Needs
    ...
    Scenario: Delete item from the Small Need list
        ...
        Then a "Shoes" costing "1000.0" should be displayed with priority "2"

    Scenario: Edit item in the Small Need list
        Given I am on the Small Needs page
        When I edit the "School Uniform"
        And I update item name "School Uniform" with "Dress"
        And I save edited need
        Then a "Dress" costing "5000.0" should be displayed with priority "1"
